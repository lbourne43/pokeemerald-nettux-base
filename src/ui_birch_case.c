...
{
    [BALL_TOP_FIRST]        = {SPECIES_MUDKIP, 5, WATER_STARTER, ITEM_NONE, BALL_POKE, NATURE_ADAMANT, 1, MON_MALE, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_GROWL, MOVE_TACKLE, MOVE_WATER_GUN}, 0, 0, 0},
    [BALL_TOP_SECOND]       = {SPECIES_TREECKO, 5, GRASS_STARTER, ITEM_NONE, BALL_POKE, NATURE_MODEST, 1, MON_MALE, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_LEER, MOVE_POUND, MOVE_LEAFAGE}, 0, 0, 0},
    [BALL_MIDDLE_FIRST]     = {SPECIES_TORCHIC, 5, FIRE_STARTER, ITEM_NONE, BALL_POKE, NATURE_ADAMANT, 1, MON_MALE, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_GROWL, MOVE_SCRATCH, MOVE_EMBER}, 0, 0, 0},

    [BALL_TOP_THIRD]        = {SPECIES_NONE, 5, GRASS_STARTER},
    [BALL_TOP_FOURTH]       = {SPECIES_NONE, 5, WATER_STARTER},
    [BALL_MIDDLE_THIRD]     = {SPECIES_NONE, 5, FIRE_STARTER},

    [BALL_MIDDLE_SECOND]    = {SPECIES_NONE, 5, GRASS_STARTER},
    [BALL_BOTTOM_FIRST]     = {SPECIES_NONE, 5, FIRE_STARTER},
    [BALL_BOTTOM_SECOND]    = {SPECIES_NONE, 5, WATER_STARTER},
};
