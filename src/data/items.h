...
// TMs/HMs. They don't have a set flingPower, as that's handled by GetFlingPowerFromItemId.
    ...
    [ITEM_TM52] =
    {
        .name = ITEM_NAME("TM52 - Trick Room"),
        .price = 500,
        .description = COMPOUND_STRING(
            "Slower Pokémon\n"
	    "move first for \n"
    ...
    [ITEM_TM56] =
    {
        .name = ITEM_NAME("TM56 - Energy Ball"),
        .price = 9000,
        .description = COMPOUND_STRING(
    ...
    [ITEM_TM57] =
    {
        .name = ITEM_NAME("TM57 - Heavy Slam"),
        .price = 9000,
        .description = COMPOUND_STRING(
    ...
    [ITEM_TM58] =
    {
        .name = ITEM_NAME("TM58 - Electroweb"),
        .price = 5000,
        .description = COMPOUND_STRING(
    ...
    [ITEM_TM59] =
    {
        .name = ITEM_NAME("TM59 - Volt Switch"),
        .price = 5000,
        .description = COMPOUND_STRING(
    ...
    [ITEM_TM60] =
    {
        .name = ITEM_NAME("TM60 - Will-O-Wisp"),
        .price = 3000,
        .description = COMPOUND_STRING(
		"Inflicts a burn on"
    ...
    [ITEM_TM61] =
    {
        .name = ITEM_NAME("TM61 - Rock Slide"),
        .price = 6000,
        .description = COMPOUND_STRING(
		"Large boulders are"
	       	"hurled. May cause\n"
    ...
    [ITEM_TM62] =
    {
        .name = ITEM_NAME("TM62 - Drain Punch"),
        .price = 3000,
    ...
    [ITEM_TM63] =
    {
        .name = ITEM_NAME("TM63 - Fire Punch"),
        .price = 3000,
        .description = sQuestionMarksDesc, // Todo
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM69] =
    {
        .name = ITEM_NAME("TM69 - Weather Ball"),
        .price = 3000,
        .description = sQuestionMarksDesc, // Todo
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM71] =
    {
        .name = ITEM_NAME("TM71 - PartingShot"),
        .price = 3000,
        .description = sQuestionMarksDesc, // Todo
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM72] =
    {
        .name = ITEM_NAME("TM72 - Baton Pass"),
        .price = 3000,
        .description = sQuestionMarksDesc, // Todo
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM73] =
    {
        .name = ITEM_NAME("TM73 - Poison Jab"),
        .price = 3000,
        .description = sQuestionMarksDesc, // Todo
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM74] =
    {
        .name = ITEM_NAME("TM74 - Mach Punch"),
        .price = 3000,
        .description = sQuestionMarksDesc, // Todo
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM75] =
    {
        .name = ITEM_NAME("TM75 - Bullet Punch"),
        .price = 3000,
        .description = sQuestionMarksDesc, // Todo
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM76] =
    {
        .name = ITEM_NAME("TM76 - PsychicFang"),
        .price = 3000,
        .description = sQuestionMarksDesc, // Todo
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM77] =
    {
        .name = ITEM_NAME("TM77 - Poison Fang"),
        .price = 3000,
        .description = sQuestionMarksDesc, // Todo
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM83] =
    {
        .name = ITEM_NAME("TM83 - ShdowPunch"),
        .price = 3000,
        .description = sQuestionMarksDesc, // Todo
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM85] =
    {
        .name = ITEM_NAME("TM85 - AuraSphere"),
        .price = 3000,
        .description = sQuestionMarksDesc, // Todo
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM89] =
    {
        .name = ITEM_NAME("TM89 - Leaf Blade"),
        .price = 3000,
        .description = sQuestionMarksDesc, // Todo
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM90] =
    {
        .name = ITEM_NAME("TM90 - Psycho Cut"),
        .price = 3000,
        .description = sQuestionMarksDesc, // Todo
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM91] =
    {
        .name = ITEM_NAME("TM91 - Flare Blitz"),
        .price = 3000,
        .description = sQuestionMarksDesc, // Todo
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM92] =
    {
        .name = ITEM_NAME("TM92 - Brave Bird"),
        .price = 3000,
        .description = sQuestionMarksDesc, // Todo
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM94] =
    {
        .name = ITEM_NAME("TM94 - Close Combat"),
        .price = 3000,
        .description = sQuestionMarksDesc, // Todo
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM95] =
    {
        .name = ITEM_NAME("TM95 - Wave Crash"),
        .price = 3000,
        .description = sQuestionMarksDesc, // Todo
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM96] =
    {
        .name = ITEM_NAME("TM96 - Wood Hammer"),
        .price = 3000,
        .description = sQuestionMarksDesc, // Todo
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM97] =
    {
        .name = ITEM_NAME("TM97 - Double Edge"),
        .price = 3000,
        .description = sQuestionMarksDesc, // Todo
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
...
// GEN 9 ITEMS
    ...
    [ITEM_INFINITE_EXP_CANDY] =
    {
        .name = ITEM_NAME("Infinite Exp. Candy"),
        .pluralName = ITEM_PLURAL_NAME("Infinite Exp. Candies"),
        .price = 0,
        .holdEffectParam = EXP_1000000,
        .description = COMPOUND_STRING(
            "Gives a very large\n"
            "amount of Exp. to\n"
            "a single Pokémon."),
